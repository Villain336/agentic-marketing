...
class ComplianceExporter:
    ...
    async def export_audit_trail(self, start_date: str, end_date: str) -> dict:
        ...
        try:
            ...
            logger.warning("db module not available — audit trail will be partial")
    ...
    async def export_data_inventory(self, user_id: str) -> dict:
        ...
        try:
            ...
            logger.warning("db module not available — data inventory will be partial")
            db = None  # type: ignore[assignment]
    ...
    async def generate_soc2_report(self, period: str) -> dict:
        ...
        try:
            ...
            logger.warning("db module not available — SOC2 report will be partial")
            db = None  # type: ignore[assignment]
        ...
        return {
            ...
            "change_management": {
                ...
                "governance_policies_active": self._count_active_policies(),
            },
            "availability": {
    ...
    async def handle_deletion_request(self, user_id: str) -> dict:
        ...
        try:
            ...
            logger.warning("db module not available — GDPR deletion will be partial (in-memory only)")
            db = None  # type: ignore[assignment]
    ...
    @staticmethod
    def _count_active_policies() -> int:
        """Safely count active governance policies."""
        try:
            from governance import policy_engine
            return len([p for p in policy_engine.list_policies() if p.enabled])
